...
interface SimpleProjectFlowProps {
  onComplete?: (projectData: Partial<ProjectData>) => void;
}

export default function SimpleProjectFlow({ onComplete }: SimpleProjectFlowProps) {
        ...
        setTimeout(() => {
          ...
          setGeneratedSchedule({
            ...
            insights: {
              ...
              criticalPath: [],
              budgetBreakdown: {
                materials: updatedData.basicInfo?.totalBudget ? Math.round(updatedData.basicInfo.totalBudget * 0.6) : 3000,
                labor: updatedData.basicInfo?.totalBudget ? Math.round(updatedData.basicInfo.totalBudget * 0.3) : 1500,
                contingency: updatedData.basicInfo?.totalBudget ? Math.round(updatedData.basicInfo.totalBudget * 0.1) : 500,
                total: updatedData.basicInfo?.totalBudget || 5000
              },
              warnings: [],
              suggestions: [],
              optimizations: [],
      ...
      <div className="text-center mb-8">
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-700">
            🔥 <strong>Firebase 연동 데모 버전</strong> - 실제 데이터는 저장되지 않지만 모든 기능을 체험할 수 있습니다
          </p>
        </div>
      </div>
      ...
      <div className="min-h-[600px]">
        ...
        {currentStep === 2 && (
          <SpaceSelectionForm
            ...
            initialData={{ spaces: projectData.spaces }}
            totalArea={projectData.basicInfo?.totalArea || 84}
            housingType={projectData.basicInfo?.housingType || 'apartment'}
          />
        )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-blue-700 space-y-2 text-sm">
                  ...
                  {currentStep === 2 && (
                    <>
                      <p>• <strong>핵심 기능!</strong> 각 공간별로 필요한 작업만 선택하여 비용을 절약할 수 있습니다.</p>
        ...
        <Card className="mt-8 bg-gray-50 border-gray-200">
          <CardContent className="p-4">
            <div className="text-xs text-gray-600">
              ...
              <div><strong>데모 모드:</strong> Firebase 연동 없이 로컬 실행</div>
